...
ZigbeeOccupancySensor::ZigbeeOccupancySensor(uint8_t endpoint, uint8_t app_device_version) : ZigbeeEP(endpoint) {
...
ZigbeeOccupancySensor::ZigbeeOccupancySensor(uint8_t endpoint) : ZigbeeOccupancySensor(endpoint, 0) {
}
